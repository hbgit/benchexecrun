...
def check_witness(benchmark_name, typeResult, witnessPath):
    ...
    if typeResult == False:
       command_line_cpa = "../../../witness_checker/CPAchecker/scripts/cpa.sh -noout -heap 10000M "+\
                          " -config ../../../witness_checker/CPAchecker/config/sv-comp17.properties "+\
                          " -spec " + property_file +\
...
#Moving witness file if it was generated
if os.path.isfile("witness.graphml"):
	os.system("mv witness.graphml witness_file/witness.graphml")
